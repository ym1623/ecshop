...
if ($_POST['act'] == 'add_seller')
{
	...
	if (!empty($seller))
	{
      ...
      if ($res)
      {
        show_group_message('信息提交成功,我们会尽快与您联系!', '', "seller.php", 'error');
      }
	}
	else
	{
		show_group_message('请把信息填写完整!', '', "seller.php", 'error');
	}
...
else
{
   ...
   $smarty->display('group_seller.dwt');
}
?>