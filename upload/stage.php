...
if (!$smarty->is_cached('group_stage.dwt', $cache_id))
{
        ...
        {
            /* 取得当前页的团购活动 */
            $group_list = group_buy_list($city_id,$cat_id,1,$size, $page);
	    ...
	    if (in_array(1,$show_groupclass))
	    {
		  ...
		  $smarty->assign('class_url',  rewrite_groupurl('stage.php'));
		  $smarty->assign('class_list', group_class_list(1,true,'stage.php'));
	    }
