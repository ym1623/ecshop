...
<div class="sect">
<h1 class="title2"><?php echo $this->_var['city_info']['city_name']; ?>热销商品</h1>
...
<a href="<?php echo $this->_var['group_buy']['url']; ?>" class="thumb"><img src="<?php echo $this->_var['group_buy']['group_image']; ?>" border="0"  width="200" height="121" alt="<?php echo htmlspecialchars($this->_var['group_buy']['group_name']); ?>" /><?php if ($this->_var['group_buy']['is_finished'] == '0'): ?><div class="ishotopen"></div><?php endif; ?></a>
