...
<div class="sect">
<h1 class="title2"><?php echo $this->_var['city_info']['city_name']; ?>近期秒杀</h1>
...
?>
<li><p class="time" style="font-size:12px;">开始 - <?php echo $this->_var['group_buy']['formated_start_date']; ?><br /> 结束 - <?php echo $this->_var['group_buy']['formated_end_date']; ?></p>
<h4><a href="<?php echo $this->_var['group_buy']['url']; ?>"><?php echo htmlspecialchars($this->_var['group_buy']['group_name']); ?></a></h4>
<a href="<?php echo $this->_var['group_buy']['url']; ?>" class="thumb"><img src="<?php echo $this->_var['group_buy']['group_image']; ?>" border="0"  width="200" height="121" alt="<?php echo htmlspecialchars($this->_var['group_buy']['group_name']); ?>" /><?php if ($this->_var['group_buy']['is_finished'] == '0'): ?><div class="ismsopen"></div><?php endif; ?></a>
<div class="info"><p class="total"><strong class="count"><?php echo $this->_var['group_buy']['orders_num']; ?></strong>人购买</p><p class="price">原价：<strong class="old"><?php echo $this->_var['group_buy']['formated_market_price']; ?></strong><br>折扣：<strong class="discount"><?php echo $this->_var['group_buy']['rebate']; ?>折</strong><br>现价：<strong><?php echo $this->_var['group_buy']['formated_cur_price']; ?></strong><br>节省：<strong><?php echo $this->_var['group_buy']['formated_rebate_price']; ?></strong></p></div></li><?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> 
</ul>
